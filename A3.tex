...
\textbf{Word count} & 7{,}569 (target 6{,}000 $\pm$ 10\%; excludes references, appendices, tables and figures) \\
\end{tabular}
...
\vspace{1.4em}
\noindent
We confirm that the contribution percentages above and the submission below are agreed by all members.
...
\input{sections/99_appendix_figures}
