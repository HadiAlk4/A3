...
\vspace{0.6em}
\noindent
Hours are equalised so that the 25.0\% shares on the title page remain valid. If a member is non-responsive for more than 48~hours, a three-tier fallback (12-hour artefact audit, PM WBS addendum, Buddycheck PAF lock) is the procedure that would reallocate these rows.
