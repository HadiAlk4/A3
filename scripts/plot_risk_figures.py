...
# Forced offsets so (2,5) R-02/R-09 and the (1,2) residual cluster stay readable.
JITTER = {
    "R-01": {"in": (-0.12, 0.10), "res": (-0.10, 0.10)},
    "R-04": {"in": (0.12, -0.10), "res": (0.10, 0.16)},
    "R-02": {"in": (-0.10, 0.08), "res": (-0.10, 0.08)},
    "R-09": {"in": (0.10, -0.08), "res": (0.10, -0.08)},
    ...
    "R-12": {"in": (0.10, 0.10), "res": (0.00, 0.00)},
}
