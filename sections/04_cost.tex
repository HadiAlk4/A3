...
Inclusions are the seventeen packages in Figure~\ref{fig:wbs}. Factory manufacture, engine research and development, and freight to the receiving gate remain out of scope, so A-100 is a zero-dollar external driver rather than a cost account. The four-person surge crew (\$22{,}400) is inside WBS~1.3.3 as planned capacity. The \$21{,}000 hybrid compression cost in Section~\ref{sec:schedule-compression} is a contingent draw against the \$78{,}890 reserve if R-14 is realised; it is not in the \$1{,}500{,}000 performance measurement baseline.

Permitting and Juru work start on 10~August because those durations must finish before hot fire. Other August--September pad cost is a PEP choice. By Gate~1 (A-111, 2~October), \$602{,}301 of planned work is already on the clock: permits, Juru, cleanroom, GSE, RF and stacking in progress. That is 40.2\% of \$1{,}500{,}000. It is planned value, not cash already paid. The leftover is \$897{,}699. Gate~1 still authorises the whole campaign. Locking remaining spend means those leftover package totals, plus the \$78{,}890 contingency rules, become the control baseline. After that, pad work cannot be added and $T$-0 cannot move without a Board variation. 2~October is not day one of spend.
