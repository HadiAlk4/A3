...
Figure~\ref{fig:resources} is the weekly demand implied by Table~\ref{tab:precedence} against those two headcount numbers. If RF calibration (A-125) stayed on Wet Dress Rehearsal and static fire, weeks 10--12 would peak at fourteen people: two above the HSE cap and six above the organic crew. That is R-13 in numbers.

The baseline does two things, in that order. First, A-125 is placed in weeks 3--6 (29~August to 15~September) using its 39 days of total float. Figure~\ref{fig:resources} shows that move: weeks 3--6 sit two people higher on the mitigated series than on the unmitigated series. The move costs \$0 and does not change 15~November, because A-125 is a feeder into A-133, not a launch-critical bar. Second, four surge technicians are hired for seven days inside WBS~1.3.3 at \$100/h loaded: $4 \times 7 \times 8 \times \$100 = \$22{,}400$, already inside the \$1{,}500{,}000 work estimate \citep{fwo2020}. Those four close the gap from organic eight to the cap of twelve. The mitigated series then peaks at twelve in weeks 11--12, on the cap and never above it. Option~C, if invoked, shortens A-134 and A-142 and does not redraw Figure~\ref{fig:resources}.

\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{resource_histogram.pdf}
\caption[Weekly pad demand versus capacity]{Weekly pad demand versus capacity. Hashed crimson bars are the unmitigated series (peak 14 in weeks 10--12) with A-125 still on WDR and static fire. Teal bars are the mitigated baseline (peak 12): A-125 sits in weeks 3--6, two people above the unmitigated series there, and four surge technicians join 1.3.3. The navy dashed line is the organic crew of eight; the crimson dotted line is the HSE occupancy cap of twelve. Eight is not a hard pad limit.}
\label{fig:resources}
\end{figure}
