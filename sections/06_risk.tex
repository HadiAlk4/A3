...
\caption[Inherent-to-residual risk matrix]{Inherent (crimson) to residual (teal) movement for all eighteen register items. $P$ is vertical and $I$ is horizontal. Most treatment arrows run down and left. R-12 keeps $P=2$ (the payload window is not made less likely) and moves $I$ only. R-02 and R-09 share the $(2,5)$ cell and are offset.}
